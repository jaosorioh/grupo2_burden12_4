...
public:
    ...
    void buildTrianglesAndNodes(vector<Triangle> &, vector<Triangle> &, vector<Triangle> &, double* (*)(const double &, double &), double* (*)(double &, const double &), vector<double> &, vector<double> &);
private:
